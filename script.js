...
var questions = [
    ...
    {
        title: "How do you create an IF statement for executing some code if 'i' is NOT equal to 6?",
        options: ["if i=! 6 then", "if (i || 6)", "if (i != 6)", "if (i % 6)"],
        answer: "if (i != 6)"
    },
    {
    ...
    },
 {
    ...
    {
        title: "Who is the founder of karu programming hub?",
        options: ["Eng lilian", "Eng Ephraim", "ENG Samuel", "Eng Edwine"],
        answer: "Eng Edwine"
    },
